...
import { Flex, StyledBox, StyledButton, StyledImg, StyledTitle } from '../styledcomponents/styled-components.ts';
export const MoviePage: FC = () => {
    ...
    return (
        <div>
            <Flex dir='column'>
                <Flex mt="30px" align="center" jstf="space-between">
                    <Flex dir="column" align="center" wid="350px" gap="30px">
                        ...
                        <Flex wid="100%" jstf="space-between" gap="20px">
                            ...
                            <StyledButton wid="160px" hig="40px" hover={'#ff0000'}>Trailer</StyledButton>
                        </Flex>
                    </Flex>
                    <Flex dir="column">
                        <StyledBox>
